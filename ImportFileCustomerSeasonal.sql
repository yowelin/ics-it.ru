...
begin
	...
	from syn.SA_CustomerSeasonal as cs
		join dbo.customer as c on cs.UID_DS_Customer = c.UID_DS
			and c_dist.ID_mapping_DataSource = 1
		join dbo.Season as s on s.Name = cs.Season
		join dbo.Customer as c_dist on cs.UID_DS_CustomerDistributor = c_dist.UID_DS
			and c_dist.ID_mapping_DataSource = 1
	...
	from syn.SA_CustomerSeasonal as cs
	left join dbo.customer as c on cs.UID_DS_Customer = c.UID_DS
